<?php echo "<script type='text/javascript'>var max_num_pages=".$wp_query->max_num_pages.";if(typeof now_num_pages=='undefined') var now_num_pages=".(isset($_GET["paged"])?$_GET["paged"]:1).";</script>";
if (!isset($_GET["data"])) { get_header(); ?>
	<div class="postlist">
		<!-- Blog Post -->
		<div id="postsbox">
<?php } $datacount = isset($_GET["data"])?$_GET["data"]+1:0; echo "<script type='text/javascript'>datacount=".$datacount.";</script>" ?>
			<?php
				$indexint = $datacount;
